...
👉 Designed to support real-time business decision making
""")
...
def generate_gpt_explanation(client, user_question, matched_question, insight, action, confidence, impact):
    if client is None:
        return "⚠️ GPT unavailable. Please check API key or billing."
...
Built by *Kamran Khan*  
- MSc Business Intelligence & Digital Marketing  
- Corporate Sales & Data Analytics Professional  
- Focus: AI-driven decision systems & customer intelligence  
""")
